    ...
    <table class="imagetable" border="0" align="center" width="70%">
        ...
        <tbody>
            ...
            <tr> 
                ...
                <td width="25%" height="100" align="center" id="tablename"><?php echo $row['name'] ?></td>
                <td width="25%" height="100" align="center" id="tabledescrip"> <?php echo $row['info'] ?></p></td>
                <td width="25%" height="100" align="center" id="tabledescrip"> <?php echo $row['subject'] ?></p></td>
            </tr>
            <?php
                }
            ?>
