    ...
    <table>
        <tr>
            <td width="30%">
                <center>
                    <?php
                        $query = "SELECT * FROM `teach_user_form2` WHERE email='math@gmail.com' ";  // ADD email here **************
                ...
                <img src="mail.png" width="20px" height="20px"> math@gmail.com<br>
            ...
            <td class="col2" width="65%">
                <b>PROFILE</b>
                <hr>
                I'm a highly skilled and experienced Mathematics teacher who is passionate about helping students develop their mathematical thinking and problem-solving skills. With a Bachelor's degree in Mathematics and a teaching certification, Sadhushan has a strong foundation in the subject matter and pedagogical techniques required to effectively teach Mathematics. He has several years of experience teaching students of various levels and backgrounds, and is skilled in creating engaging lesson plans and activities that promote student learning and curiosity.<br><br>
                <b>WORK EXPERIENCE</b>
                <hr>
                <ul>
                    <li>
